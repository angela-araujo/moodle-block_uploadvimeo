...
/**
 * Strings for component 'block_uploadvimeo', language 'pt_br',
 * 
 *  
...
// Settings.
$string['config_clientid'] = '<strong>Client ID</strong> para a conta do Vimeo';
$string['config_clientsecret'] = '<strong>Client Secret</strong> para a conta do Vimeo';
$string['config_accesstoken'] = '<strong>Access Token</strong> para a conta do Vimeo';
